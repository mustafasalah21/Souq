using MyRepository = AdminPanell.Administration.Repositories.UserPermissionRepository;
using MyRow = AdminPanell.Administration.UserPermissionRow;

namespace AdminPanell.Administration.Endpoints;
