using MyRepository = AdminP.Administration.Repositories.UserPermissionRepository;
using MyRow = AdminP.Administration.UserPermissionRow;

namespace AdminP.Administration.Endpoints;
